...
public partial class App : System.Windows.Application
{
  ...
  public App()
  {
    ...
    _ = services.AddSingleton<MainNavView>(s => new MainNavView(s.GetRequiredService<ILogger>()) { DataContext = s.GetRequiredService<SmrePOC.VM.VMs.MainVM>() });
  ...
  protected async override void OnStartup(StartupEventArgs e)
  {
    ...
    await mainVM.InitAsync();                 // blocking due to vesrion checker.
  }
